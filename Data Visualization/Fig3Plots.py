...
f.savefig(file_loc + '/fig3_GoF.svg', format='svg') # replace ... by the saving location
...
f.savefig(file_loc + '/fig3_Yoda1.svg', format='svg') # replace ... by the saving location
...
f.savefig(file_loc + '/fig3_cKO.svg', format='svg') # replace ... by the saving location
