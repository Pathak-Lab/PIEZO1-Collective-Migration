function [y] = difHg(ul,ur,uu,ud,uc,uul,uur,udl,udr,ull,urr,uuu,udd,params,ul2,ur2,uu2,ud2,uc2,uul2,uur2,udl2,udr2,ull2,urr2,uuu2,udd2,Alp,D,D1)
% 2/21/2022
% diffusion
% inputs: 
% 
...
elseif alp_type == 2 % H2 model
    y = d.*(...
        d1.*(ul.*uls.*(1-ucs).*(1-alp.*ull-alp2.*ull2).*(1-alp.*udl-alp2.*udl2).*(1-alp.*uul-alp2.*uul2)...
        +ur.*urs.*(1-ucs).*(1-alp.*urr-alp2.*urr2).*(1-alp.*udr-alp2.*udr2).*(1-alp.*uur-alp2.*uur2)...
        -uc.*ucs.*(1-urs).*(1-alp.*ul-alp2.*ul2).*(1-alp.*ud-alp2.*ud2).*(1-alp.*uu-alp2.*uu2)...
        -uc.*ucs.*(1-uls).*(1-alp.*ur-alp2.*ur2).*(1-alp.*ud-alp2.*ud2).*(1-alp.*uu-alp2.*uu2))...
        +d2.*(uu.*uus.*(1-ucs).*(1-alp.*uuu-alp2.*uuu2).*(1-alp.*uur-alp2.*uur2).*(1-alp.*uul-alp2.*uul2)...
        +ud.*uds.*(1-ucs).*(1-alp.*udd-alp2.*udd2).*(1-alp.*udr-alp2.*udr2).*(1-alp.*udl-alp2.*udl2)...
        -uc.*ucs.*(1-uds).*(1-alp.*uu-alp2.*uu2).*(1-alp.*ur-alp2.*ur2).*(1-alp.*ul-alp2.*ul2)...
        -uc.*ucs.*(1-uus).*(1-alp.*ud-alp2.*ud2).*(1-alp.*ur-alp2.*ur2).*(1-alp.*ul-alp2.*ul2)))/(h^2);
